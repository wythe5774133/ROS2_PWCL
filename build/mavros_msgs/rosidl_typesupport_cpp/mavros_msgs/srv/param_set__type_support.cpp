...
static const _ParamSet_Request_type_support_symbol_names_t _ParamSet_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mavros_msgs, srv, ParamSet_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mavros_msgs, srv, ParamSet_Request)),
  }
};
...
{
  return &::mavros_msgs::srv::rosidl_typesupport_cpp::ParamSet_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, mavros_msgs, srv, ParamSet_Request)() {
  return get_message_type_support_handle<mavros_msgs::srv::ParamSet_Request>();
}
...
static const _ParamSet_Response_type_support_symbol_names_t _ParamSet_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mavros_msgs, srv, ParamSet_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mavros_msgs, srv, ParamSet_Response)),
  }
};
...
{
  return &::mavros_msgs::srv::rosidl_typesupport_cpp::ParamSet_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, mavros_msgs, srv, ParamSet_Response)() {
  return get_message_type_support_handle<mavros_msgs::srv::ParamSet_Response>();
}
...
static const _ParamSet_type_support_symbol_names_t _ParamSet_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mavros_msgs, srv, ParamSet)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mavros_msgs, srv, ParamSet)),
  }
};
...
{
  return &::mavros_msgs::srv::rosidl_typesupport_cpp::ParamSet_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, mavros_msgs, srv, ParamSet)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<mavros_msgs::srv::ParamSet>();
}
