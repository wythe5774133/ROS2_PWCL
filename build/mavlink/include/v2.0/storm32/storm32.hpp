...
enum class MAV_STORM32_GIMBAL_DEVICE_FLAGS : uint16_t
{
    ...
    RC_MIXED=2048, /* RC control. The RC input signal fed to the gimbal device is mixed into the gimbal's orientation. Is overridden by RC_EXCLUSIVE flag if that is also set. | */
